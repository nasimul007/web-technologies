			...
			<div class="playarea">
				...
				<div class="clearfix">
					...
					<div class="img-container">
						<img src="3.png" id="dice1" style="width:100%">
					</div>
					<div class="img-container">
						<img src="6.png" id="dice2" style="width:100%">
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	function rollDice()
	{
        ...
        {
	        case 1:
	            document.getElementById("dice1").src = "1.png";
	            break;
	        case 2:
                document.getElementById("dice1").src = "2.png";
                break;
            case 3:
                document.getElementById("dice1").src = "3.png";
                break;
            case 4:
                document.getElementById("dice1").src = "4.png";
                break;
            case 5:
                document.getElementById("dice1").src = "5.png";
                break;
            case 6:
                document.getElementById("dice1").src = "6.png";
                break;
        }
    ...
    function play()
    {
        ...
        if ( gameStatus == CONTINUE_ROLLING )
        {
            ...
            document.getElementById("status").innerHTML = "Status : " + "Roll Again";
        }
        else
        {
            if ( gameStatus == WON )
            {
                ...
                document.getElementById("status").innerHTML = "Status : " + "Player wins.";
            ...
            else
            {
                ...
                document.getElementById("status").innerHTML = "Status : " + "Player loses.";
                document.getElementById("point").value = "";
                //location.reload(true);
            }
            firstRoll = true;
